...
export const counsellingCategories = [
  { id: "josaa", label: "JoSAA" },
  { id: "upcet", label: "UPCET" },
  { id: "wbjee", label: "WBJEE" },
  { id: "mhtcet", label: "MHTCET" },
  { id: "mpdte", label: "MPDTE" },
  { id: "jac-delhi", label: "JAC Delhi" },
  { id: "jac-chandigarh", label: "JAC Chandigarh" },
  { id: "comedk", label: "COMEDK" },
  { id: "kcet", label: "KCET" },
  { id: "tnea", label: "TNEA" },
  { id: "ts-eamcet", label: "TS EAMCET" },
  { id: "ap-eamcet", label: "AP EAMCET" },
  { id: "neet", label: "NEET" },
  { id: "jee-advanced", label: "JEE Advanced" },
  { id: "jee-mains", label: "JEE Mains" },
  { id: "bitsat", label: "BITSAT" },
  { id: "nchmct", label: "NCHMCT" },
